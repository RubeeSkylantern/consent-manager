var ConsentManager=(()=>{var w=Object.defineProperty;var H=Object.getOwnPropertyDescriptor;var K=Object.getOwnPropertyNames;var U=Object.prototype.hasOwnProperty;var Y=(t,e)=>{for(var o in e)w(t,o,{get:e[o],enumerable:!0})},J=(t,e,o,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of K(e))!U.call(t,n)&&n!==o&&w(t,n,{get:()=>e[n],enumerable:!(r=H(e,n))||r.enumerable});return t};var X=t=>J(w({},"__esModule",{value:!0}),t);var ae={};Y(ae,{getHeadSnippet:()=>T,init:()=>V});var u="__cm_consent";function z(){try{let t=localStorage.getItem(u);if(!t)return null;let e=JSON.parse(t);if(e&&e.v===1&&e.c)return e}catch{}return null}function O(t){let e={v:1,t:Date.now(),c:{...t}},o=JSON.stringify(e);try{localStorage.setItem(u,o)}catch{}try{let r=[`${u}=${encodeURIComponent(o)}`,"max-age=33696000","path=/","SameSite=Lax"];location.protocol==="https:"&&r.push("Secure"),document.cookie=r.join("; ")}catch{}return e}function L(){try{localStorage.removeItem(u)}catch{}try{document.cookie=`${u}=; max-age=0; path=/; SameSite=Lax`}catch{}}function R(t){if(!t||!t.t)return!0;let e=33696e3*1e3;return Date.now()-t.t>e}var d={necessary:{id:"necessary",required:!0,defaultValue:!0},analytics:{id:"analytics",required:!1,defaultValue:!1},marketing:{id:"marketing",required:!1,defaultValue:!1},personalization:{id:"personalization",required:!1,defaultValue:!1}},m=Object.keys(d);function f(){let t={};for(let[e,o]of Object.entries(d))t[e]=o.defaultValue;return t}function T(){return"(function(){var d={ad_storage:'denied',analytics_storage:'denied',ad_user_data:'denied',ad_personalization:'denied',personalization_storage:'denied',functionality_storage:'granted',security_storage:'granted'};try{var c=JSON.parse(localStorage.getItem('__cm_consent'));if(c&&c.c){if(c.c.analytics)d.analytics_storage='granted';if(c.c.marketing){d.ad_storage='granted';d.ad_user_data='granted';d.ad_personalization='granted'}if(c.c.personalization)d.personalization_storage='granted'}}catch(e){}window.dataLayer=window.dataLayer||[];function g(){window.dataLayer.push(arguments)}window.gtag=g;g('consent','default',d);g('set','url_passthrough',true);g('set','ads_data_redaction',d.ad_storage==='denied')})();"}function Q(t){return{analytics_storage:t.analytics?"granted":"denied",ad_storage:t.marketing?"granted":"denied",ad_user_data:t.marketing?"granted":"denied",ad_personalization:t.marketing?"granted":"denied",personalization_storage:t.personalization?"granted":"denied",functionality_storage:"granted",security_storage:"granted"}}function A(t){if(typeof window>"u")return;let e=Q(t);window.dataLayer=window.dataLayer||[],window.gtag||(window.gtag=function(){window.dataLayer.push(arguments)}),window.gtag("consent","update",e),window.gtag("set","ads_data_redaction",e.ad_storage==="denied")}var S="__cm_proof";function W(){let t=new Uint8Array(4);return crypto.getRandomValues(t),Array.from(t,e=>e.toString(16).padStart(2,"0")).join("")}async function Z(t){try{let o=new TextEncoder().encode(t),r=await crypto.subtle.digest("SHA-256",o);return"sha256-"+Array.from(new Uint8Array(r)).map(a=>a.toString(16).padStart(2,"0")).join("")}catch{return null}}function ee(){try{let t=localStorage.getItem(S);if(!t)return[];let e=JSON.parse(t);return Array.isArray(e.proofs)?e.proofs:[]}catch{return[]}}function te(t){try{localStorage.setItem(S,JSON.stringify({proofs:t}))}catch{}}async function $(t,e){let o={id:W(),timestamp:new Date().toISOString(),version:1,action:t,categories:{...e}},r=JSON.stringify({id:o.id,timestamp:o.timestamp,action:o.action,categories:o.categories});o.hash=await Z(r);let n=ee();for(n.push(o);n.length>5;)n.shift();return te(n),o}function I(){try{localStorage.removeItem(S)}catch{}}function j(){let t={};return{on(e,o){(t[e]||(t[e]=[])).push(o)},off(e,o){let r=t[e];r&&(t[e]=r.filter(n=>n!==o))},emit(e,o){let r=t[e];r&&r.forEach(n=>n(o))}}}var b=class{constructor(e={}){this.config=e,this.emitter=j(),this.categories=f(),this._initialized=!1,this._pendingCallbacks=[],this._ui=null,this._decided=!1}init(){if(this._initialized)return;this._initialized=!0;let e=z();e&&!R(e)?(this.categories={...f(),...e.c},this._decided=!0,this._syncReopener(),this._flushPendingCallbacks()):(this.categories=f(),this.showBanner())}acceptAll(){for(let e of m)this.categories[e]=!0;this._save("accept_all"),this.emitter.emit("consent:accept-all",this.categories),this.hideBanner()}rejectAll(){for(let e of m)this.categories[e]=d[e].required;this._save("reject_all"),this.emitter.emit("consent:reject-all",this.categories),this.hideBanner()}acceptCategories(e){for(let o of m)d[o].required?this.categories[o]=!0:this.categories[o]=e.includes(o);this._save("accept_custom"),this.hideBanner()}hasConsent(e){return!!this.categories[e]}onConsent(e,o){this.hasConsent(e)?o():this._pendingCallbacks.push({category:e,callback:o})}showBanner(){this._ui&&(this._ui.showBanner(),this.emitter.emit("banner:show"))}hideBanner(){this._ui&&(this._ui.hideBanner(),this.emitter.emit("banner:hide"))}showModal(){this._ui&&this._ui.showModal(this.categories)}reset(){L(),I(),this._decided=!1,this.categories=f(),A(this.categories),this._pendingCallbacks=[],this.showBanner()}getCategories(){return{...this.categories}}on(e,o){this.emitter.on(e,o)}off(e,o){this.emitter.off(e,o)}_setUI(e){this._ui=e,this._decided&&this._syncReopener()}_syncReopener(){this._ui&&typeof this._ui.showReopener=="function"&&this._ui.showReopener()}_save(e){this._decided=!0,O(this.categories),A(this.categories),$(e,this.categories),this.emitter.emit("consent:update",this.categories),this._flushPendingCallbacks()}_flushPendingCallbacks(){let e=[];for(let o of this._pendingCallbacks)this.hasConsent(o.category)?o.callback():e.push(o);this._pendingCallbacks=e}};function M(t){let e=t.texts||{},o=document.createElement("div");return o.className="cm-banner cm-hidden",o.setAttribute("role","dialog"),o.setAttribute("aria-label",e.bannerAriaLabel||"Gestion des cookies"),o.innerHTML=`
  ...
  `,o.addEventListener("click",r=>{let n=r.target.closest("[data-cm-action]");if(!n)return;let a=n.dataset.cmAction;a==="accept"&&t.onAcceptAll&&t.onAcceptAll(),a==="reject"&&t.onRejectAll&&t.onRejectAll(),a==="customize"&&t.onCustomize&&t.onCustomize()}),o}var P='button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])';function q(t){let e=null;function o(r){if(r.key==="Tab"){let n=t.querySelectorAll(P);if(n.length===0)return;let a=n[0],c=n[n.length-1];r.shiftKey?document.activeElement===a&&(r.preventDefault(),c.focus()):document.activeElement===c&&(r.preventDefault(),a.focus())}}return{activate(){e=document.activeElement,t.addEventListener("keydown",o);let r=t.querySelector(P);r&&r.focus()},deactivate(){t.removeEventListener("keydown",o),e&&e.focus&&e.focus()}}}function B(t){let e=t.texts||{},o=e.categories||{},r=null,n=document.createElement("div");n.className="cm-overlay cm-hidden",n.setAttribute("role","presentation");let a=document.createElement("div");a.className="cm-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label",e.modalTitle||"Param\xE8tres des cookies"),n.appendChild(a);function c(i){a.innerHTML=`
    ...
    `}function v(i,s,l){let h=d[i],E=l?.label||i,_=l?.description||"",C=l?.cookies||[];return`
      <div class="cm-category">
        <div class="cm-category-header">
          <div>
            <span class="cm-category-name">${E}</span>
            ${h.required?'<span class="cm-category-required">(obligatoire)</span>':""}
          </div>
          ...
          <details class="cm-category-details">
            ...
            ${C.length?`
              <ul class="cm-cookie-list">
                ${C.map(y=>`<li><strong>${y.name}</strong> \u2014 ${y.description}${y.duration?` (${y.duration})`:""}</li>`).join("")}
              </ul>
            `:""}
          </details>
        `:""}
      </div>
    `}n.addEventListener("click",i=>{if(i.target===n){p();return}let s=i.target.closest("[data-cm-action]");if(!s)return;let l=s.dataset.cmAction;if(l==="accept-all"&&t.onAcceptAll&&(t.onAcceptAll(),p()),l==="confirm"){let h=g();t.onConfirm&&t.onConfirm(h),p()}}),n.addEventListener("keydown",i=>{i.key==="Escape"&&p()});function g(){let i=a.querySelectorAll("[data-cm-category]"),s=[];return i.forEach(l=>{l.checked&&s.push(l.dataset.cmCategory)}),s}function k(i){c(i),n.classList.remove("cm-hidden"),r=q(a),r.activate()}function p(){n.classList.add("cm-hidden"),r&&(r.deactivate(),r=null),t.onClose&&t.onClose()}return{overlay:n,show:k,hide:p}}function G(t){let e=document.createElement("button");return e.className="cm-reopener cm-hidden",e.setAttribute("aria-label",t.ariaLabel||"Modifier mes pr\xE9f\xE9rences cookies"),e.setAttribute("title",t.title||"Cookies"),e.textContent="\u{1F36A}",e.addEventListener("click",()=>{t.onClick&&t.onClick()}),e}var N=`/* ==============================================
